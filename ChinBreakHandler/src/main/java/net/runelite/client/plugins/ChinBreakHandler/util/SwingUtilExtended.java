...
public class SwingUtilExtended {
  ...
  /**
   * Sets some sensible defaults for swing. IMPORTANT! Needs to be called before main frame
   * creation
   */
   ...
   */
  @Nullable
  public static TrayIcon createTrayIcon(@Nonnull final Image icon, @Nonnull final String title,
   ...
   */
  public static void syncExec(final Runnable r)
